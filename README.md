<p align="center">
  <img src="assets/logo-128.png" alt="LogVault" width="112" height="112" />
</p>

<h1 align="center">AstrBot LogVault</h1>
...
- **WebUI 日志中心**。六页签控制台，六套皮肤（含玻璃荧光）：总览、日志浏览、实时跟随、全局搜索、导出中心与维护清理。
...
- **导出中心**：按范围（预设 / 当前分类 / 勾选文件 / 指定插件）、时间窗口、级别与关键词构建导出，输出 ZIP 或合并 TXT，可先预检再执行；导出历史支持重复下载、删除与清空。
